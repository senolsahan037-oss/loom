...
### GAP-009
- **Timestamp**: 2026-09-03T23:15:00+03:00
- **Category**: Mix analysis from Live's playback (no render)
- **Description**: Measure the mix from what Live is actually playing, without an export: "a device that records stereo on every play".
